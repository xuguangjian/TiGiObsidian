...
.theme-dark {/*黑夜模式*/
  ...
  --blue: #61afef;
  --yellow: #e5c07b;
  --yykys: #43468340;  /*{{λ:/obsidian中文教程/}}颜色 */
  --btys: #7292B1;     /*H6 标题颜色 */
  --bqys: #7880a3;     /*标签颜色*/
  --bqds: #404b5ef5;     /*标签底色*/
...
.theme-light {/*白天模式*/
  ...
  --yellow: #e35649;
  --orange: #986800;
  --yykys: #e1f4ff59;    /*{{λ:/obsidian中文教程/}}颜色 */
  --btys: #B6C0C0;     /*H6 标题颜色 */
  --bqys: #6f8c6382;   /*标签颜色*/
  --bqds: #eaeaea;     /*标签底色*/
...
.markdown-preview-view .file-embed {
  ...
  background-color: var(--yykys); /* {{λ:/obsidian中文教程/}}引用块颜色 */
  border: 0px sold var(--yykys);  /* {{λ:/obsidian中文教程/}}引用块边线 */
  margin: 0;
  border-radius: 4px;
}
